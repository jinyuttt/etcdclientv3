    ...
    public abstract class Op
    {
        ...
        public class GetOp : Op
        {
            ...
            RequestOp toRequestOp()
            {
                ...
                {
                    Key = this.key,
                    CountOnly = this.option.IsCountOnly(),
                    Limit = this.option.GetLimit(),
                    Revision = this.option.GetRevision(),
                    KeysOnly = this.option.IsKeysOnly(),
                    Serializable = this.option.isSerializable(),
